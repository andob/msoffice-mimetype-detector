...
public class MimeTypes
{
    ...
    public static final String APPLICATION_OFFICE_WORD_LEGACY = "application/msword";
    public static final String APPLICATION_OFFICE_EXCEL_LEGACY = "application/vnd.ms-excel";
    public static final String APPLICATION_OFFICE_POWER_POINT_LEGACY = "application/vnd.ms-powerpoint";
}
